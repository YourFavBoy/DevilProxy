    ...
    if (var.get(0).m_key == "action" && var.get(0).m_value == "input") {
        ...
        //deleted for private reasons ;)
            ...
            paket =
                ...
                "\nadd_textbox|`4IMPORTANT: `oDiscord: DEVIL#0141.|left|2480|"
                "\nadd_quick_exit|"
                "\nend_dialog|end|Cancel|Okay|";
            variantlist_t liste{ "OnDialogRequest" };
            liste[1] = paket;
...
"\nadd_spacer|small|\n\nadd_url_button||`1Join Discord Server``|NOFLAGS|https://discord.gg/b4GfZWtPrM|Open link?|0|0|"
"\nadd_textbox|`wDecember 26th: `5Don't Forget Join Discord Server https://discord.gg/b4GfZWtPrM |left|"
"\nadd_spacer|small|"
"\nadd_textbox|`wDecember 26th: `5Proxy made by DEVIL#0141 |left|"
"\nadd_spacer|small|"
...
"\nadd_textbox|Don't forget to join our `2Official Proxy Discord Server`` on `2https://discord.gg/b4GfZWtPrM `` or click the link below!|left|"
...
"\nadd_image_button|iotm_layout_4|interface/large/gazette/gazette_5columns_social_btn06.rttex|5imageslayout|https://discord.gg/b4GfZWtPrM|Would you like to join our "
"discord?|"
"\nadd_layout_spacer|2imageslayout|"
"\nadd_textbox||\nadd_spacer|small|"
"\nadd_textbox||\nadd_spacer|small|"
